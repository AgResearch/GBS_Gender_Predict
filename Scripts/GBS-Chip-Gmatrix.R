...
## This is script is taken from KGD version v0.2
## Available from github at https://github.com/AgResearch/KGD
## Some of the plots are commented out to reduce the amount of output produced
...
readTD <- function(genofilefn0 = genofile) {
  ...
  if (havedt) {
   ...
   seqID <<-as.matrix(genosin[,1])[,1]# allows any name for first col
   nind <<- length(seqID)
